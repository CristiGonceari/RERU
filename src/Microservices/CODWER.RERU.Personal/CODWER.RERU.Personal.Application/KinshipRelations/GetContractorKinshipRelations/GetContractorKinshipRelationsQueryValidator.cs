...
{
    public class GetContractorKinshipRelationsQueryValidator : AbstractValidator<GetContractorKinshipRelationsQuery>
    {
        public GetContractorKinshipRelationsQueryValidator(AppDbContext appDbContext)
        {
