...
{
    public class TransferToNewPositionCommandValidator : AbstractValidator<TransferToNewPositionCommand>
    {
        public TransferToNewPositionCommandValidator(AppDbContext appDbContext)
        {
