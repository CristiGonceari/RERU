...
{
    public class GetCurrentContractorPositionQueryValidator : AbstractValidator<GetCurrentContractorPositionQuery>
    {
        public GetCurrentContractorPositionQueryValidator(AppDbContext appDbContext)
        {
