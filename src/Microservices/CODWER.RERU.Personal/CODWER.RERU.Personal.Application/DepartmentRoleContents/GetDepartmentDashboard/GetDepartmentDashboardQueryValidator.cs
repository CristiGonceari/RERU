...
{
    public class GetDepartmentDashboardQueryValidator : AbstractValidator<GetDepartmentDashboardQuery>
    {
        public GetDepartmentDashboardQueryValidator(AppDbContext appDbContext)
        {
