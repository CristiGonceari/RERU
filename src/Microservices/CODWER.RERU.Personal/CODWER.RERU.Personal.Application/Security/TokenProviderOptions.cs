...
namespace CODWER.RERU.Personal.Application.Security
{
    public sealed class TokenProviderOptions
    {
        ...
        /// <summary>
        /// Set the timespan the token will be valid for (default is 1 day/86400 seconds)
        /// </summary>
        public TimeSpan ValidFor => TimeSpan.FromDays(1);
