...
{
    internal class GetEmployeeFunctionsQueryHandler : IRequestHandler<GetEmployeeFunctionsQuery, List<SelectItem>>
    {
        ...
        public async Task<List<SelectItem>> Handle(GetEmployeeFunctionsQuery request, CancellationToken cancellationToken)
        {
            ...
            return _mapper.Map<List<SelectItem>>(employeeFunctions);
        }
    }
}
