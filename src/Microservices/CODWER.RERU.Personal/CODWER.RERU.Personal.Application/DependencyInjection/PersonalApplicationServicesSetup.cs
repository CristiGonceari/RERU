    ...
    public static class PersonalApplicationServicesSetup
    {
        ...
        public static void ConfigureValidatorServices(this IServiceCollection services, IHostingEnvironment currentEnvironment)
        {
            services
                ...
                .AddScoped(typeof(IImportEmployeeFunctionsService), typeof(ImportEmployeeFunctionsService))
                ...
                .AddScoped(typeof(IImportDepartmentOrganizationalChartService), typeof(ImportDepartmentOrganizationalChartService));
        }
    }
}
