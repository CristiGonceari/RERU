...
{
    public class GetContractorRecommendationForStudyQueryValidator : AbstractValidator<GetContractorRecommendationForStudyQuery>
    {
        public GetContractorRecommendationForStudyQueryValidator(AppDbContext appDbContext)
        {
