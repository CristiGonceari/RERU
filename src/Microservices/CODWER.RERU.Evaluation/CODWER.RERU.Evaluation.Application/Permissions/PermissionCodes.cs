namespace CODWER.RERU.Evaluation.Application.Permissions
{
    public static class PermissionCodes
    {
        ...
        public const string ACCES_GENERAL_LA_LOCATII = "P03000201";

        public const string ACCES_GENERAL_LA_PLANURI = "P03000301";

        public const string ACCES_GENERAL_LA_CATEGORII = "P03000401";

        public const string ACCES_GENERAL_LA_INTREBARI = "P03000501";

        public const string ACCES_GENERAL_LA_TESTE = "P03000601";

        public const string ACCES_GENERAL_LA_INTREBARILE_TESTULUI = "P03000701";

        public const string ACCES_GENERAL_LA_SABLOANELE_DE_TESTE = "P03000801";
