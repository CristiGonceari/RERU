...
{
    public class StartEvaluationCommandValidator : AbstractValidator<StartEvaluationCommand>
    {
        public StartEvaluationCommandValidator(AppDbContext appDbContext, IUserProfileService userProfileService)
        {
            RuleFor(x => x.TestId)
