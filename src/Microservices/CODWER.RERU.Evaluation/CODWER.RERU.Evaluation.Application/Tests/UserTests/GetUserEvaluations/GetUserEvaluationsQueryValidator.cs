...
{
    public class GetUserEvaluationsQueryValidator : AbstractValidator<GetUserEvaluationsQuery>
    {
        public GetUserEvaluationsQueryValidator(AppDbContext appDbContext)
        {
            RuleFor(x => x.UserId)
