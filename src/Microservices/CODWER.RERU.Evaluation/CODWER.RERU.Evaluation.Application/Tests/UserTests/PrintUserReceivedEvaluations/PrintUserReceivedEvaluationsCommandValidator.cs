...
{
    public class PrintUserReceivedEvaluationsCommandValidator : AbstractValidator<PrintUserReceivedEvaluationsCommand>
    {
        public PrintUserReceivedEvaluationsCommandValidator(AppDbContext appDbContext)
        {
