...
{
    public class GetUserEvaluatedTestsQueryValidator : AbstractValidator<GetUserEvaluatedTestsQuery>
    {
        public GetUserEvaluatedTestsQueryValidator(AppDbContext appDbContext)
        {
            RuleFor(x => x.UserId)
