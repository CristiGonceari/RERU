...
{
    public class GetUserTestsByEventQueryValidator : AbstractValidator<GetUserTestsByEventQuery>
    {
        public GetUserTestsByEventQueryValidator(AppDbContext appDbContext)
        {
            RuleFor(x => x.UserId)
