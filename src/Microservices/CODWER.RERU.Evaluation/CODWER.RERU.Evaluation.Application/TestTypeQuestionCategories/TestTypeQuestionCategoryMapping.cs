...
{
    public class TestTypeQuestionCategoryMapping : Profile
    {
        public TestTypeQuestionCategoryMapping()
        {
            CreateMap<AssignQuestionCategoryToTestTypeDto, TestTypeQuestionCategory>()
