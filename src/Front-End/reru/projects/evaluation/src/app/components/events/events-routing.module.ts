...
const routes: Routes = [
  ...
  { path: 'add-event', component: AddEditEventsComponent },
  { path: 'edit-event/:id', component: AddEditEventsComponent },
  { 
    path: 'event/:id', 
    ...
    children: [
      ...
      { path: 'persons', component: ResponsiblePersonsComponent},
      { path: 'locations', component: LocationsListComponent },
      { path: 'test-types', component: TestTemplatesListComponent },
      { path: 'users', component: AttachedUsersListComponent },
      { path: 'evaluators', component: EvaluatorsComponent }
    ]
  },
  { path: 'attach-person/:id', component: AttachComponent },
  { path: 'attach-location/:id', component: AttachComponent },
  { path: 'attach-user/:id', component: AttachComponent },
  { path: 'attach-test-type/:id', component: AttachComponent },
  { path: 'attach-evaluator/:id', component: AttachComponent },
]
