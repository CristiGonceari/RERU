...
export class LayoutsComponent implements OnInit {
	...
	sidebarItems: any[] = [
        ...
        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            11 13,10.3284271 13,9.5 L13,5.5 C13,4.67157288 13.6715729,4 14.5,4 Z M14.5,13 L18.5,13 C19.3284271,
            13 20,13.6715729 20,14.5 L20,18.5 C20,19.3284271 19.3284271,20 18.5,20 L14.5,20 C13.6715729,20 13,
            19.3284271 13,18.5 L13,14.5 C13,13.6715729 13.6715729,13 14.5,13 Z" fill="#000000" opacity="0.3"/>
          </g>
        </svg>`,
		},
		{
	...
	translateData(): void {
		...
		]).subscribe(([home, settings, tests, categories, questions, test, verifyTest,statistic, event, location, events, plan, help, faq]) => {
			this.sidebarItems[0].name = home;
			this.sidebarItems[1].name = settings;
			this.sidebarItems[2].name = tests;
			this.sidebarItems[3].name = categories;
			this.sidebarItems[4].name = questions;
			this.sidebarItems[5].name = test;
			this.sidebarItems[6].name = verifyTest;
			this.sidebarItems[7].name = statistic;
			this.sidebarItems[8].name = event;
			this.sidebarItems[9].name = location;
			this.sidebarItems[10].name = events;
			this.sidebarItems[11].name = plan;
			this.sidebarItems[12].name = help;
			this.sidebarItems[13].name = faq;
		});
	}
