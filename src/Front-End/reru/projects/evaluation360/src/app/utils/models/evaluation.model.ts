...
export class EvaluationClass implements EvaluationModel {
	...
	constructor(evaluation?: EvaluationModel) {
		if (evaluation) {
			...
			this.educationEnum = +evaluation.educationEnum || null;
			this.professionalTrainingActivities = +evaluation.professionalTrainingActivities || null;
			this.professionalTrainingActivitiesType = +evaluation.professionalTrainingActivitiesType || null;
			...
			this.serviceDuringEvaluationCourse = +evaluation.serviceDuringEvaluationCourse || null;
			...
			this.qualificationEvaluationObtainedPreviousYear = +evaluation.qualificationEvaluationObtainedPreviousYear || null;
