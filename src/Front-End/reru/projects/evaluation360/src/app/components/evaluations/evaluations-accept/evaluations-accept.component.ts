...
@Component({
  selector: 'app-evaluations-accept',
  templateUrl: './evaluations-accept.component.html',
  styleUrls: ['./evaluations-accept.component.scss']
})
export class EvalationsAcceptComponent implements OnInit {
