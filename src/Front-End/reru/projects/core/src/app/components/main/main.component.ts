...
export class MainComponent implements OnInit {
	...
	sidebarItems: any[] = [
		...
		{
			permissions: ['P00000001', 'P00000012', 'P00000026', 'P00000027'],
	...
	translateData(): void {
		forkJoin([
			...
			// this.translate.get('departments.departments'),
			// this.translate.get('user-roles.roles'),
			this.translate.get('faq.help'),
			this.translate.get('faq.faq')
		]).subscribe(
			([
				home, profile, administration, modules, users, help, faq
			]) => {
