...
export class AppComponent implements OnInit, AfterViewInit {
	...
	translateData(): void {
		forkJoin([
			...
			this.translate.get('sidebar.my-profile'),
			this.translate.get('sidebar.personal-management'),
			...
			([
				...
				this.sidebarItems[2].name = management;
