...
namespace CVU.ERP.Module.MVC.Controllers.Internal {
    [ApiController]
    ...
    public class PermissionController : Controller {
        ...
        [HttpGet]
        public async Task<Response<ModulePermission[]>> GetPermissions () {
            ...
            var response = new Response<ModulePermission[]> (permissions.ToArray ());
