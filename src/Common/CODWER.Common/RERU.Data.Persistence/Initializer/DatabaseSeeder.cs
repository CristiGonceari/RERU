...
namespace RERU.Data.Persistence.Initializer
{
    public static class DatabaseSeeder
    {
        public static void SeedDb(AppDbContext appDbContext)
        {
            ...
            AddEmployeeFunction(appDbContext);
        }
        ...
        private static void AddEmployeeFunction(AppDbContext appDbContext)
        {
            List<EmployeeFunction> functionsToAdd = new List<EmployeeFunction>()
            {
                new EmployeeFunction { Name = "Șef inspectorat general", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef (comandant) departament", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Director", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef direcție generală", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef direcție", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef direcție în cadrul direcției generale", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef secție", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef secție în cadrul direcției", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Ofițer de legătură", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef serviciu", Type = EvaluationTypeEnum.Conducere },

                new EmployeeFunction { Name = "Ofițer principal", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Ofițer superior", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Ofițer", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Specialist principal", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Specialist superior", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Specialist", Type = EvaluationTypeEnum.Execuție },

                new EmployeeFunction { Name = "Șef inspectorat național", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Director/șef", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef direcție generală", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Comandant brigadă", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef direcție", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef direcție în cadrul direcției generale", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Comandant detașament", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef obiect special", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef centru independent", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef secție", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef secție în cadrul direcției", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef serviciu", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Comandant companie", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Comandant pluton", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Comandant grup", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Comandant patrulă", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef unitate (în componența altei unități bugetare)", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Comandant/șef echipă", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef stație", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef patrulă", Type = EvaluationTypeEnum.Conducere },

                new EmployeeFunction { Name = "Ofițer principal", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Ofițer superior", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Ofițer", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Expert-criminalist principal", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Expert-criminalist superior", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Expert-criminalist", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Specialist principal", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Specialist superior", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Specialist", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Inspector", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Subofițer superior", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Chinolog cu rang de subofițer", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Chimist-dozimetrist", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Plutonier", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Subofițer de patrulare", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Subofițer", Type = EvaluationTypeEnum.Execuție },

                new EmployeeFunction { Name = "Șef direcție municipiu", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef direcție regională", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Comandant brigadă", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef inspectorat de poliție municipal", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef inspectorat de poliție de sector al municipiului Chișinău", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef inspectorat de poliție raional", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef direcție", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Comandant regiment", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Comandant batalion independent", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Comandant detașament", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Comandant batalion în componența altei unități", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Comandant unitate independentă", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef secție", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef serviciu", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Comandant companie", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef secție raională", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef izolator", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef birou", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef sector", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef schimb", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Comandant pluton", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef post", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Comandant grup", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef unitate", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef gardă", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef grup", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef echipă", Type = EvaluationTypeEnum.Conducere },
                new EmployeeFunction { Name = "Șef stație radio", Type = EvaluationTypeEnum.Conducere },

                new EmployeeFunction { Name = "Ofițer principal: operativ de serviciu, de sector, criminalist", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Ofițer superior: operativ de serviciu, de sector, criminalist", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Ofițer: operativ de serviciu, de sector, criminalist", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Ofițer principal: de investigații, de urmărire penală", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Ofițer superior: de investigații, de urmărire penală", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Ofițer superior: de investigații, de urmărire penală", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Ofițer principal", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Ofițer superior", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Ofițer", Type = EvaluationTypeEnum.Execuție },
                ...
                new EmployeeFunction { Name = "Expert-criminalist superior", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Expert-criminalist", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Inspector principal", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Inspector superior", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Inspector", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Specialist principal", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Specialist superior", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Specialist", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Subofițer superior", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Salvator superior", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Pompier superior", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Scafandru", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Salvator", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Pompier", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Plutonier", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Subofițer", Type = EvaluationTypeEnum.Execuție },
                new EmployeeFunction { Name = "Carabinier cu rang de subofițer", Type = EvaluationTypeEnum.Execuție }
            };

            foreach (var function in functionsToAdd)
            {
                if (!appDbContext.EmployeeFunctions.Any(x => x.Name == function.Name))
                {
                    appDbContext.EmployeeFunctions.Add(function);
                }
            }
